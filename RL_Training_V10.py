...
from ot2_env_wrapper_V8 import OT2Env  # Import the new env
...
parser.add_argument("--learning_rate", type=float, default=0.006, help="Learning rate for the optimizer")
parser.add_argument("--batch_size", type=int, default=256, help="Batch size for updating policy and value networks")
...
task = Task.init(project_name='Mentor Group S/Group 3',
                 task_name='RL_230036_W_V8_T_V10')
